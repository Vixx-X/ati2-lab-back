    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_course', models.CharField(max_length=255, verbose_name='favorite course')),
                ('notification_frecuency', models.CharField(max_length=255, verbose_name='notification frecuency')),
            ],
            options={
                'verbose_name': 'client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=255, verbose_name='social value')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='socials', to='client.commonclient', verbose_name='Country')),
            ],
            options={
                'verbose_name': 'Social',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='client.commonclient', verbose_name='Country')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='client.country', verbose_name='Country')),
            ],
            options={
                'verbose_name': 'Social',
                'verbose_name_plural': 'Socials',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offered_services', models.CharField(max_length=255, verbose_name='offered services')),
                ('object_id', models.PositiveIntegerField()),
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'business'), ('model', 'Business')), models.Q(('app_label', 'client'), ('model', 'ParticularClient')), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
            ],
            options={
                'verbose_name': 'client',
                'verbose_name_plural': 'clients',
